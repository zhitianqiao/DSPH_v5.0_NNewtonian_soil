...
//inline tmatrix3d ToTMatrix3d(const tmatrix3f& v) { return(TMatrix3d(v.a11, v.a12, v.a13, v.a21, v.a22, v.a23, v.a31, v.a32, v.a33)); }
...
inline tsymatrix3f TSymMatrix3f(float xx, float xy, float xz, float yy, float yz, float zz) { tsymatrix3f m = { xx, xy, xz, yy, yz, zz }; return(m); }

///Symmetric matrix 3x3 of 6 values of type double.
typedef struct {
	double xx, xy, xz, yy, yz, zz;
}tsymatrix3d;
inline tsymatrix3d TSymMatrix3d() { tsymatrix3d m = { 0,0,0,0,0,0 }; return(m); }
inline tsymatrix3d TSymMatrix3d(double xx, double xy, double xz, double yy, double yz, double zz) { tsymatrix3d m = { xx, xy, xz, yy, yz, zz }; return(m); }

///Converts \ref tsymatrix3f to \ref tsymatrix3d.
inline tsymatrix3d ToTsymatrix3D(const tsymatrix3f& v) { return(TSymMatrix3d(v.xx, v.xy, v.xz, v.yy, v.yz, v.zz)); }
...
inline const char* TypeToStr(TpTypeData type){
  switch(type){
	...
	case TypeSyMatrix3d: return("tsymatrix3d");
  }
  return("???");
}
...
inline unsigned SizeOfType(TpTypeData type){
  switch(type){
	...
	case TypeSyMatrix3d: return(sizeof(tsymatrix3d));
  }
  return(0);
}
