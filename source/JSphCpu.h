...
protected:
  ...
  void ComputeVerletVarsFluid(bool shift, const tfloat3 *indirvel, const tfloat4 *velrhop1, const tfloat4 *velrhop2, const tsymatrix3f* sigma1, tsymatrix3f* sigma2, double dt, double dt2, tdouble3 *pos, unsigned *cell, typecode *code, tfloat4 *velrhopnew, tsymatrix3f* sigmanew)const;
